...
export const createPRTool = {
    ...
    execute: async () => {
        try {
            ...
            const existingPR = await axios.get(`https://api.github.com/repos/${GITHUB_OWNER}/${GITHUB_REPO}/pulls`, {
                headers: {
            ...
            // 6. Create PR
            const res = await axios.post(`https://api.github.com/repos/${GITHUB_OWNER}/${GITHUB_REPO}/pulls`, {
